...
class Pagination extends Component {
    ...
    renderPagination = () => {
        if (this.props.data) {
            ...
            return pageList.map(value => <li  className={this.props.currentCoursesByCategory.currentPage === value - 1 ? "page-item active" : "page-item"} onClick={(event) => this.onPageClick(value - 1, event)}><a className="page-link">{value}</a></li>)
        }
    }
    render() {
